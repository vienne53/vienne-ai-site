...
- **从 0 准备本地文件 → 推送 GitHub**
- **GitHub Pages 部署上线（静态站）**
- **Vercel 部署（让 AI 分身在网页上可用）**
...
- **学习笔记页**：`notes.html` + `learn/llm-agent/` 九章系统课（见 `docs/学习笔记部署说明.md`）
...
├─ notes.html                 # 笔记页
├─ learn/llm-agent/           # 从 LLM 到 Agent 九章课程（静态 HTML）
├─ scripts/
│  └─ sync-learn-course.ps1   # 从本地课程项目同步 HTML
├─ images/                    # 图片资源
├─ docs/                      # 文档
├─ api/
